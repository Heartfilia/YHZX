...
DRIVERS = ['Firefox', '']
RECEIVERS = ''
GOAL_URL = 'http://www.yyw.com'
LOGIN_URL = 'https://my.yyw.com/login.php'
CART_URL = 'https://my.yyw.com/mycart.php'
ADDRESS_SETTING = 'https://my.yyw.com/addressManage.php'

RETRY = 0     # 重试次数

REG_INFO = {'email': 'testinfo@gets.com', 'password': 'test_info'}
ADDRESS_INFO = {'city': 'california', 'street': 'Richmond', 'post_code': '23227'}
CREDIT_CARD = {'number': '5329596084636851',
               'expire': '1121',
               'cvv': '384',
               'first_name': 'Adam',
               'last_name': 'Lambert',
               'address1': '2555 Huntington Dr. STE C',
               'postal': '90713',
               'city': 'Lakewood',
               'state': '',
               'mobile': '3447117557',
               'email': 'testinfo@gets.com'
               }
