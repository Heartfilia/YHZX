    ...
    def params_get_2(self, dataList, session):
        if dataList:
            for data in dataList:
                ...
                # resp = session.get(self.url, params=params, headers=headers, verify=False)
